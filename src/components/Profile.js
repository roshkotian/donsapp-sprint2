...
import image from "../purdueLogo.jpg";
...
class Profile extends Component {
    ...
    render() {
        ...
        let { latestImage } = this.state
        const { classes, fname, lname, username, role, department, email, createdAt } = this.props
        return (
                        ...
                        <Grid item sm={11}>
                            <div className={classes.profile}>
                                <div className="image-wrapper">
                                    <img src={image} alt="profile" className="profile-image" className={classes.image} />
                                    <input
                                        type="file"
                                        id="imageInput"
                                        hidden="hidden"
